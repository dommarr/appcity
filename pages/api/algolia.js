...
export default async function(req, res) {
    ...
    catalog.forEach(function(elem) {
        ...
        const price_pay_monthly = elem.price_pay_monthly === null ? null : formatPrice(elem.price_pay_monthly)
        const price_pay_yearly = elem.price_pay_yearly === null ? null : formatPrice(elem.price_pay_yearly)
        const starting_price_pay_monthly = elem.starting_price_pay_monthly === null ? null : formatPrice(elem.starting_price_pay_monthly)
        const starting_price_pay_yearly = elem.starting_price_pay_yearly === null ? null : formatPrice(elem.starting_price_pay_yearly)
        // Assign display and sort prices
        elem.price_other_pay_monthly ? obj.price_pay_monthly = elem.price_other_pay_monthly : obj.price_pay_monthly = price_pay_monthly
        elem.price_other_pay_yearly ? obj.price_pay_yearly = elem.price_other_pay_yearly : obj.price_pay_yearly = price_pay_yearly
        ...
        elem.sort_by_starting_price ? obj.sort_price_monthly = elem.starting_price_pay_monthly : obj.sort_price_monthly = elem.price_pay_monthly
        elem.sort_by_starting_price ? obj.sort_price_yearly = elem.starting_price_pay_yearly : obj.sort_price_yearly = elem.price_pay_yearly
        obj.categories = {}
