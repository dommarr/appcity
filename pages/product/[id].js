        ...
        <div className="h-full w-full md:w-2/5 flex flex-col justify-center items-center p-5">
          ...
          {tier != null && (
            <div className="flex flex justify-start items-center w-36 mb-4">
              <button type="button" className={`flex-shrink-0 group relative rounded-full inline-flex items-center justify-center h-5 w-10 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`} aria-pressed="false" onClick={() => setMonthly(!monthly)}>
                ...
                <span aria-hidden="true" className={`${monthly ? "bg-indigo-300" : "bg-gray-300"} pointer-events-none absolute h-4 w-9 mx-auto rounded-full transition-colors ease-in-out duration-200`}></span>
                {/* Enabled: "translate-x-5", Not Enabled: "translate-x-0" */}
                <span aria-hidden="true" className={`${monthly ? "translate-x-5" : "translate-x-0"} pointer-events-none absolute left-0 inline-block h-5 w-5 border border-gray-200 rounded-full bg-white shadow transform ring-0 transition-transform ease-in-out duration-200`}></span>
              </button>
              <span className="ml-3" id="billing-label">
                <span className="text-base font-normal text-gray-900">{monthly ? "Pay monthly" : "Pay yearly"}</span>
              </span>
            </div>
          )}
          {/* Price Block */}
        ...
        <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
          <div className="sm:flex sm:flex-col sm:align-center">
            ...
            <div className="relative self-center mt-6 bg-gray-100 rounded-lg p-0.5 flex sm:mt-8">
              <button type="button" className="relative w-1/2 bg-white border-gray-200 rounded-md shadow-sm py-2 text-sm font-medium text-gray-700 whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:z-10 sm:w-auto sm:px-8">
                Monthly billing
              </button>
