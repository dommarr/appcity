        ...
        <div className="flex items-center">
          <a href="/" className="flex">
            <img
              ...
              alt={appName}
            />
            <span className="px-2 text-4xl text-yellow font-bold italic">
              {appName}
            </span>
          </a>
        </div>
        ...
        <div className="hidden md:flex-1 md:flex md:items-center md:justify-between">
          ...
          <div className="flex items-center md:ml-12">
            ...
            <a
              ...
              className={`${
                props.dark
                  ? "text-purple bg-white hover:bg-gray-200"
                  : "text-white bg-purple hover:bg-purple-extradark"
        ...
        <div className="shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
          <div className="pt-5 pb-6 px-5">
            <div className="flex items-center justify-between">
              ...
              <div className="-mr-2">
                <button
                  type="button"
                  className="bg-white p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-purple-extralight"
          ...
          <div className="py-6 px-5">
            ...
            <div className="mt-6">
              <a
                href="/"
                className="w-full flex items-center justify-center px-4 py-2 border border-transparent shadow-sm text-base font-medium text-white bg-purple hover:bg-purple-extradark"
              >
                Sign up
              </a>
              <p className="mt-6 text-center text-base font-medium text-gray-500">
                ...
                <a
                  href="/"
                  className="text-purple hover:text-purple-extralight pl-1"
                >
                  Sign in
                </a>
              </p>
